...
// Initialization and Shutdown
		...
		public static extern UInt32 humblenet_version();

		[DllImport (NativeLibraryName, CallingConvention = CallingConvention.Cdecl)]
		public static extern bool humblenet_init();

		[DllImport (NativeLibraryName, CallingConvention = CallingConvention.Cdecl)]
		public static extern void humblenet_shutdown();

// Error Handling

		[DllImport (NativeLibraryName, CallingConvention = CallingConvention.Cdecl)]
		public static extern string humblenet_get_error();

		[DllImport (NativeLibraryName, CallingConvention = CallingConvention.Cdecl)]
		public static extern void humblenet_set_error( string error );

		[DllImport (NativeLibraryName, CallingConvention = CallingConvention.Cdecl)]
		public static extern void humblenet_clear_error();

		[DllImport (NativeLibraryName, CallingConvention = CallingConvention.Cdecl)]
		public static extern bool humblenet_set_hint( string name, string value );

		[DllImport (NativeLibraryName, CallingConvention = CallingConvention.Cdecl)]
		public static extern string humblenet_get_hint( string name );

// WebRTC / P2P Support

		[DllImport (NativeLibraryName, CallingConvention = CallingConvention.Cdecl)]
		public static extern bool humblenet_p2p_supported();

// P2P Interface

		[DllImport (NativeLibraryName, CallingConvention = CallingConvention.Cdecl)]
		public static extern bool humblenet_p2p_is_initialized();

		[DllImport (NativeLibraryName, CallingConvention = CallingConvention.Cdecl)]
		public static extern bool humblenet_p2p_init( string server, string client_token, string client_secret, string auth_token );

		[DllImport (NativeLibraryName, CallingConvention = CallingConvention.Cdecl)]
		public static extern UInt32 humblenet_p2p_get_my_peer_id();

		[DllImport (NativeLibraryName, CallingConvention = CallingConvention.Cdecl)]
		public static extern bool humblenet_p2p_register_alias( string name );

		[DllImport (NativeLibraryName, CallingConvention = CallingConvention.Cdecl)]
		public static extern bool humblenet_p2p_unregister_alias( string name );

		[DllImport (NativeLibraryName, CallingConvention = CallingConvention.Cdecl)]
		public static extern UInt32 humblenet_p2p_virtual_peer_for_alias( string name );

		[DllImport (NativeLibraryName, CallingConvention = CallingConvention.Cdecl)]
		public static extern int humblenet_p2p_sendto( byte[] message, UInt32 length, UInt32 topeer, SendMode sendmode, byte channel );

		[DllImport (NativeLibraryName, CallingConvention = CallingConvention.Cdecl)]
		public static extern int humblenet_p2p_recvfrom( byte[] message, UInt32 length, out UInt32 topeer, byte channel );

		[DllImport (NativeLibraryName, CallingConvention = CallingConvention.Cdecl)]
		public static extern bool humblenet_p2p_peek( out UInt32 length, byte channel );

		[DllImport (NativeLibraryName, CallingConvention = CallingConvention.Cdecl)]
		public static extern bool humblenet_p2p_disconnect( UInt32 peer );

		[DllImport (NativeLibraryName, CallingConvention = CallingConvention.Cdecl)]
		public static extern bool humblenet_p2p_wait( int timeout_ms );
